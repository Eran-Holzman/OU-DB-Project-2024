...
- **Text Analysis Functions**:
  ...
  - Display statistics for articles based on words and phrases.
    ...
    <img src="https://i.imgur.com/axd3qwF.png" alt="Statistics 1" width="300" style="margin-bottom: 10px;"/>
    <img src="https://i.imgur.com/NJHscYY.png" alt="Statistics 2" width="300" style="margin-bottom: 10px;"/>
  </div>
